...
if not uploaded_file:
    ...
    mock_logs = pd.DataFrame([
        {"DATE": "2026-07-20", "NAME": "Anil Kumar", "SCHOOL NAME": "Greenwood High", "WORK TYPE": "New Admission", "STATUS": "Completed"},
        {"DATE": "2026-07-20", "NAME": "Anil Kumar", "SCHOOL NAME": "Greenwood High", "WORK TYPE": "Fee configuration", "STATUS": "Completed"},
        {"DATE": "2026-07-20", "NAME": "Sita Verma", "SCHOOL NAME": "DPS Public School", "WORK TYPE": "Absentees", "STATUS": "Completed"},
        {"DATE": "2026-07-21", "NAME": "Sita Verma", "SCHOOL NAME": "DPS Public School", "WORK TYPE": "Data Checking", "STATUS": "Pending"},
        {"DATE": "2026-07-20", "NAME": "Rajesh Sharma", "SCHOOL NAME": "Apex International", "WORK TYPE": "Data Upload", "STATUS": "Pending"}
    ])
...
if uploaded_file:
    ...
    with tab2:
        ...
        if sort_order == "Lowest to Highest":
            sorted_df = summary_df.sort_values(by="Overall Score", ascending=True).reset_index(drop=True)
        else:
            sorted_df = summary_df.sort_values(by="Overall Score", ascending=False).reset_index(drop=True)
        ...
        fig_rank = px.bar(
            ...
            category_orders={"NAME": sorted_df['NAME'].tolist()}  # Enforces exact sorted order on chart
        )
